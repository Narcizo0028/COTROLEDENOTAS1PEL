...
<body>
  ...
  <header class="site-header" id="topo">
    ...
    <div class="nav-wrap container">
      ...
      <nav id="menu-principal" class="main-nav" aria-label="Navegação principal">
        ...
        <a href="#notas">Notas e lançamento</a>
      ...
      <div class="container hero-grid">
        <div class="hero-copy">
          ...
          <div class="hero-actions">
            <a class="button button-gold" href="#notas">Entrar e lançar notas</a>
    ...
    <section class="section grade-section" id="notas" aria-labelledby="grades-title">
      <div class="container grade-grid">
        <div class="grade-intro">
          ...
          <h2 id="grades-title">Notas e lançamento</h2>
          <p>Informe sua matrícula e seu código individual para consultar o boletim e lançar suas próprias notas.</p>
          <ul class="check-list">
            <li>Consulta privada e individual</li>
            <li>Lançamento das suas provas e trabalhos</li>
        ...
        <div class="form-card">
          <form id="grade-form" novalidate>
            ...
            <button class="button button-gold full" type="submit">Entrar na área do aluno</button>
  ...
  <script src="script.js?v=20260723-12" defer></script>
</body>
</html>
